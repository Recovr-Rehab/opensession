...
const MINI_MENU =
	"fixed z-[321] max-h-[60vh] overflow-y-auto rounded-popup border border-line-strong bg-popup-glass [backdrop-filter:var(--popup-blur)] p-[5px] shadow-[0_12px_34px_rgba(0,0,0,0.4)] animate-[hovercard-in_var(--dur-micro)_var(--ease)]";
