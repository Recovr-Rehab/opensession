  ...
  return (
    <div className="mx-auto mb-3 max-w-[var(--session-col)]">
      <button
        ...
        className="flex w-full min-w-0 cursor-pointer items-center gap-2 rounded-control border-0 bg-transparent px-1 py-1 text-left font-sans text-supporting text-dim hover:bg-hover"
      >
        <span
          className={cn(
