		...
		<Menu.Root>
			<Menu.Trigger
				className={cn(
					...
					compact
						? "gap-0 rounded-[999px] p-0.5 hover:[--team-face-ring:var(--row-chip-hover)] hover:bg-[var(--team-face-ring)] hover:text-fg data-[popup-open]:[--team-face-ring:var(--row-chip-hover)] data-[popup-open]:bg-[var(--team-face-ring)] data-[popup-open]:text-fg"
