...
export function DiffPanel({ sessionId, isRunning, canSend, send, diff }: Props) {
  ...
  return (
    <div className="flex min-h-0 flex-col" ref={panelRef}>
      {multi && (
        <div className="sticky top-0 z-2 flex gap-1 overflow-x-auto border-b border-divider bg-surface px-2.5 py-1.5">
          {changed.map((r, i) => {
      ...
      <div className="sticky top-0 z-1 flex items-center gap-2.5 overflow-x-auto border-b border-divider bg-surface px-3.5 py-2.5 text-label whitespace-nowrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
