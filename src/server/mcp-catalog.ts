...
export const MCP_SERVER_CATALOG: McpServerCatalogEntry[] = [
  {
    ...
    wiring: ["src/server/interactive-mcp.ts", "src/agents/slack/handlers.ts", "src/server/automations.ts"],
  ...
  },
  {
    ...
    wiring: ["src/server/interactive-mcp.ts", "src/agents/slack/handlers.ts"],
  ...
  },
  {
    ...
    wiring: ["src/server/interactive-mcp.ts", "src/agents/slack/handlers.ts", "src/server/goal-runner.ts"],
  ...
  },
  {
    ...
    wiring: ["src/server/interactive-mcp.ts", "src/server/automations.ts"],
  ...
  },
  {
    ...
    wiring: ["src/server/automations.ts"],
    runClasses: ["automation"],
    build: () =>
  ...
  },
  {
    ...
    wiring: ["src/agents/slack/handlers.ts"],
    runClasses: ["slack"],
  ...
  },
  {
    ...
    source: "src/agents/slack/goal-tools.ts",
    wiring: ["src/server/goal-runner.ts", "src/server/interactive-mcp.ts"],
    runClasses: ["goal"],
