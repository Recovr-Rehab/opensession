...
export function PrPanel({
  ...
  return (
    ...
    >
      ...
      <div
        className={`shrink-0 bg-surface desktop:mt-2.5 desktop:overflow-hidden desktop:rounded-lg desktop:border desktop:border-line ${compactToolbar ? `sticky top-0 z-20 desktop:mb-0 desktop:ml-2 ${WS_SUMMARY_REVIEW_CLEARANCE}` : "desktop:mx-2 desktop:mb-2"}`}
      >
